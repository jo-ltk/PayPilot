...
interface RefundTrendChartInnerProps {
  series: TrendPoint[];
}
...
/** Recharts bar chart for daily refund volume. */
export const RefundTrendChartInner = memo(function RefundTrendChartInner({
  series,
}: RefundTrendChartInnerProps) {
